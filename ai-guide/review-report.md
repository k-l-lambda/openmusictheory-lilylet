...
| Topic | OMT Sources | Description |
|-------|-------------|-------------|
| Harmonic analysis methods | `harmonicAnalysis.md`, `RNfromFB.md`, `VAT.md` | "How to analyze" procedures, notation standards |
| Classical theme functions | `classicalThemes.md`, `themeFunctions.md` | Theme function taxonomy beyond sentence/period |
| Compound forms | `compoundSentence.md`, `compoundPeriod.md` | Important form-generation constraints |
| Sonata modules & POAs | `sonataThematicModules.md`, `sonataStructuralPointsOfArrival.md` | P/TR/MC/S/C module inventory |
| Rondo thematic function | `thematicFunctionInRondo.md` | Refrain/episode functional layer |

#### Medium Priority

| Topic | OMT Sources | Description |
|-------|-------------|-------------|
| Pop/rock pattern pages | `popRockHarmony-dooWop.md`, `-lament.md`, `-pachelbel.md`, etc. | Individual patterns as constraint sheets |
| Post-tonal procedures | `normalOrder.md`, `setClassAndPrimeForm*.md` | Step-by-step analysis procedures |
...
| File | Needed Content | Priority |
|------|----------------|----------|
| `sonata-form.md` | Module inventory (P/TR/MC/S/C) + POA checklist | High |
| `rondo-form.md` | Thematic function layer | High |
| `terminology.md` | Analysis output schema (JSON-like fields) | High |
| `pop-rock-progressions.md` | Split into individual pattern pages | Medium |
| `pitch-class-sets.md` | Analysis procedure steps | Medium |
| `twelve-tone.md` | Transformation operations | Medium |
...
2. ⏳ Add high-priority missing topics
3. ⏳ Expand existing files
4. ⏳ Consider medium-priority additions
